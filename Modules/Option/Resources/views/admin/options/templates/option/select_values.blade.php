 ...
 @if($option->is_color)
      <td>
            <input
                type="color"
                <% if (optionId === undefined) { %>
                    name="values[<%- valueId %>][code]"
                    id="values-<%- valueId %>-code"
                <% } else { %>
                    name="options[<%- optionId %>][values][<%- valueId %>][code]"
                    id="option-<%- optionId %>-values-<%- valueId %>-code"
                <% } %>
                class="form-control"
                value="<%- value.code %>"
            >
            <div background-color: <%- value.code %>;"></div>
        </td> 
