...
Route::get('orders_export/export',[
    'as' => 'admin.orders.export',
    'uses' => 'OrderStatusController@export'
]);




Route::post('orders/tracking/update', [
    'as' => 'admin.orders.tracking.update',
    'uses' => 'OrderStatusController@updateTracking',
]);
