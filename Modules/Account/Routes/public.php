...
Route::middleware('auth')->group(function () {
    ...
    Route::get('account/cancelOrder/{id}', 'AccountOrdersController@cancelOrder')->name('account.orders.cancel');
    Route::get('account/orders/{id}/cancel', 'AccountOrdersController@cancel')->name('account.orders.cancelview');
    Route::post('account/orders/{id}/cancel', 'AccountOrdersController@cancel_submit')->name('account.orders.cancelsubmit');
