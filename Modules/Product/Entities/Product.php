...
class Product extends Model
{
     ...
     */
    protected $appends = [
        'base_image', 'formatted_price', 'formatted_member_price','rating_percent', 'is_in_stock',
    ...
    public function scopeForCard($query)
    {
        $query->withName()
            ...
            ->addSelect([
                'products.id',
                'products.is_product_configurable',
                'products.parent_id',
                'products.slug',
                'products.in_stock',
    ...
    {
        return $this->hasMany(ProductVariation::class,'product_parent_id','parent_id');
    }

        public function varitions()
    {
        return $this->hasMany(ProductVariation::class,'option_id','id');
    }
      ...
      public function product_options()
    {
     ...
     public function varitions_size($color_id)
    {
        return ProductVariation::where('product_parent_id',$this->parent_id)->where('option_value_id',$color_id)->where('status',1)->get();
    }


        public function parent_product()
    {
        return $this->hasMany(ProductVariation::class,'product_parent_id','id');
            
    }
         public function product_partions()
    {
    ...
    public function getMemberPriceAttribute($member_price)
    {
        return Money::inDefaultCurrency($member_price);
    }

     public function getFormattedMemberPriceAttribute()
    {
        return member_price_formatted($this);
    }
    ...
    public function url()
    {
        ...
        return route('products.show', ['slug' => $this->id]);
    }
    ...
    public function saveRelations($attributes = [])
    {
        ...
        $this->product_options(array_get($attributes, 'product_options', []));
