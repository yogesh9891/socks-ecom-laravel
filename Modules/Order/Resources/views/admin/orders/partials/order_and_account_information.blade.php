                            ...
                            @if($order->status === 'processing')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-lg-9 col-md-10 col-sm-10">
                                                 <a href="#" id="tracking_id" data-type="text" data-pk="{{ $order->id }}" data-placement="right" data-placeholder="Required" data-title="Enter your Tracking id" class="tracking_id editable editable-click editable-empty" style="display: inline;">{{ $order->tracking_id }}</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
